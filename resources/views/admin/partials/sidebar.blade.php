<nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#pharmacy" aria-expanded="false" aria-controls="ui-basic">
                <i class="menu-icon typcn typcn-coffee"></i>
                <span class="menu-title">Pharmacy Request</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="pharmacy">
                <ul class="nav flex-column sub-menu">
{{--                  <li class="nav-item">--}}
{{--                    <a class="nav-link" href="{{route('pharmacy.create')}}">Add Pharmacy</a>--}}
{{--                  </li>--}}
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('pharmacy.index')}}">All Request</a>
                  </li>
                </ul>
              </div>
            </li>
